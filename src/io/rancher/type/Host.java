...
public class Host extends AbstractType {
    ...
    private Double storageTotal=0.0;
    
    public Double getStorageTotal() {
    	Map<String,Object>   diskInfo = (Map)info.get("diskInfo");
    	Map<String,Object> mountPoints  = (Map)diskInfo.get("mountPoints");
    	Set<Entry<String, Object>> entrys = mountPoints.entrySet();
    	Iterator<Entry<String, Object>>  entrysIterator = entrys.iterator();
    	while(entrysIterator.hasNext()){
    		Entry<String,Object> mentry =  entrysIterator.next();
    		Map<String,Double> valueMap = (Map<String,Double>)mentry.getValue();
    		storageTotal = storageTotal + valueMap.get("total");
    	}
		return storageTotal/1000;
	}
