...
public interface StoragePoolService {
  ...
  @GET("storagePool/{id}/volumes")
  Call<TypeCollection<Volume>> volumes(@Path("id") String id);
  
  @GET("storagePool/{id}/volumes")
  Call<TypeCollection<Volume>> volumes(@Path("id") String id,@QueryMap Filters filters);
