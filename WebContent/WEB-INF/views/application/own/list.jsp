                              ...
                              <div class="col-md-12 col-sm-12 col-xs-12">
                                 <div class="row">
                                    <c:forEach var="environment" items="${environments}">
                                    	...
                                    	<a href="detail?envId=${environment.id}&name=${environment.name}"><img src="<%=basePath%>/assets/img/badge1.png">
                                    	</a>
                                    	<h5 style="align-content: center">
                                    	<a href="detail?envId=${environment.id}&name=${environment.name}" style="color: #39568b; font-weight: bold " 
                                    	title="${environment.name}">
                                    	  <font size="4">${environment.name}</font>
                                    	</a>
                                    	</h5>
                                    	<h5 style="align-content: center">
                                    	    <font size="4" color="#32CD32">${environment.state}</font>
                                    	</h5>
                                    	</div>
                                    	</div>
                                    </c:forEach>
                                    <div class="col-md-2 col-sm-4 col-xs-6">
                                       <div class="text-center"><a href="<%=basePath%>/marketing/app/list"><img src="<%=basePath%>/assets/img/badge_add.png"></a><h5 style="align-content: center"><a href="#" style="color: #39568b; font-weight: bold " title="添加新应用" >添加新应用</a></h5></div></div>
                                 </div>
                              </div>
                           </div>
                        </div>
