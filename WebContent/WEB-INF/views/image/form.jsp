            ...
            <div class="modal-body">
               <form id="sys_dlg_form" role="form">
                  <div class="form-group">
                     <label>名称</label>
                     <input id="sys_dlg_form_1" name="name" type="text" placeholder="输入集群名称" class="form-control">
                  </div>
                  <div class="form-group">
                     <label>描述</label>
                     <input id="sys_dlg_form_2" name="name" type="text" placeholder="输入集群描述" class="form-control">
                  </div>
               </form>
            </div>
